...
<div class="profile-tab bg-white shadow-bottom" >
    <div class="container-fluid">
        <ul class="nav nav-light nav-tabs" role="tablist">
            <li class="nav-item">
                <a href="#tabProfile" data-toggle="tab" class="d-flex h-60p align-items-center nav-link">Send SMS</a>
            </li>
            <li class="nav-item">
                <a href="#tabProfileUpdate" data-toggle="tab" class="d-flex h-60p align-items-center nav-link">Coming soon</a>
            </li>
{{--             <li class="nav-item">
                        ...
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex align-items-center" href="#tabProfile1" data-toggle="tab" onclick="updatetoggle('#tabProfile1')" id="tabli_1" style="cursor: pointer;">
                                    <i class="ion ion-md-sunny mr-15"></i>Basic Details{{-- <span class="badge badge-light badge-pill ml-15">06</span> --}}
                                </li>
                ...
                <div class="hk-row">
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            ...
                            <h6 class="hk-sec-title"> Comimg soon</h6>
